...
public:
  ...
  TFSIMD_FORCE_INLINE __m get128() const { return mVec128; }
  TFSIMD_FORCE_INLINE void set128(__mv128) { mVec = v128; }
#else
  tfScalar m_floats[4];
#endif
...
public:
  ...
  TFSIMD_FORCE_INLINE tfScalar length2() const { return dot(*this); }

  TFSIMD_FORCE_INLINE tfScalar length() const { return tfSqrt(length2()); }

  TFSIMD_FORCE_INLINE tfScalar distance2(const Vector3 &v) const;

  TFSIMD_FORCE_INLINE tfScalar distance(const Vector3 &v) const;

  TFSIMD_FORCE_INLINE Vector3 &normalize() { return *this /= length(); }

  TFSIMD_FORCE_INLINE Vector3 normalized() const;

  TFSIMD_FORCE_INLINE Vector3 rotate(const Vector3 &wAxis,
  ...
  TFSIMD_FORCE_INLINE int furthestAxis() const { return absolute().minAxis(); }

  TFSIMD_FORCE_INLINE int closestAxis() const { return absolute().maxAxis(); }

  TFSIMD_FORCE_INLINE void setInterpolate3(const Vector3 &v0, const Vector3 &v1,
                                           tfScalar rt) {
  ...
  void setZero() { setValue(tfScalar(0.), tfScalar(0.), tfScalar(0.)); }
...
//     {
//             return Vector3(v1.m_floats[0] / v2.m_floats[0],v1.m_floats[1] /
//             v2.m_floats[1],v1.m_floats[2] / v2.m_floats[2]);
//     }
